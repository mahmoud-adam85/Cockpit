...
class CCDataSource {
    ...
    init() {
        ...
        let dataSaved = CCCell(title: "Data Saved", description: "enough for another video", widget: CCDataSavedWidget(quanitity: 251, scale: "MB"))
        ...
        let phishingProtection = CCCell(title: "Phishing protection", description: "so that you can swim freely", widget: CCAntiPhishingWidget())
